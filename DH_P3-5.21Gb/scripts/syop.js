(function () {
  ...
  function renderGauges() {
    ...
    GAUGES.forEach((gauge) => {
      ...
      gaugeWrapper.appendChild(renderGaugeSVG(gauge));
      gaugeWrapper.appendChild(createEl('div', { class: 'syop-gauge-label' },
        createEl('span', { class: 'gauge-title' }, 'Avg SYOP')
      ));
