(function () {
  ...
  const BAR_GRADIENTS = {
    QB: [
      { offset: '0%', color: '#FF8EC6', opacity: 0.18 },
      { offset: '48%', color: '#FF4D8B', opacity: 0.42 },
      { offset: '100%', color: '#C9356D', opacity: 0.62 }
    ],
    RB: [
      { offset: '0%', color: '#7DFFE6', opacity: 0.16 },
      { offset: '50%', color: '#30F2CD', opacity: 0.42 },
      { offset: '100%', color: '#0CB89B', opacity: 0.6 }
    ],
    WR: [
      { offset: '0%', color: '#A7D4FF', opacity: 0.18 },
      { offset: '52%', color: '#6EB8FF', opacity: 0.44 },
      { offset: '100%', color: '#357FE6', opacity: 0.62 }
    ],
    TE: [
      { offset: '0%', color: '#E0C0FF', opacity: 0.18 },
      { offset: '50%', color: '#C18BFF', opacity: 0.44 },
      { offset: '100%', color: '#8344DE', opacity: 0.64 }
    ],
    DEFAULT: [
      { offset: '0%', color: '#A1A8FF', opacity: 0.22 },
      { offset: '100%', color: '#6A64FF', opacity: 0.54 }
    ]
  };
