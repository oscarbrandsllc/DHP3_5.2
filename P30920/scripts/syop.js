(function () {
  ...
  const BAR_GRADIENTS = {
    QB: [
      { offset: '0%', color: '#FF5C95', opacity: 0.18 },
      { offset: '55%', color: '#FF3A75', opacity: 0.42 },
      { offset: '100%', color: '#B21F52', opacity: 0.66 }
    ],
    RB: [
      { offset: '0%', color: '#51F0D1', opacity: 0.16 },
      { offset: '56%', color: '#00EBC7', opacity: 0.4 },
      { offset: '100%', color: '#0AA585', opacity: 0.64 }
    ],
    WR: [
      { offset: '0%', color: '#7AB8FF', opacity: 0.18 },
      { offset: '55%', color: '#58A7FF', opacity: 0.44 },
      { offset: '100%', color: '#2B6FE0', opacity: 0.66 }
    ],
    TE: [
      { offset: '0%', color: '#C692FF', opacity: 0.18 },
      { offset: '56%', color: '#B469FF', opacity: 0.46 },
      { offset: '100%', color: '#6F28C9', opacity: 0.68 }
    ],
    DEFAULT: [
