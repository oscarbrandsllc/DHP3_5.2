(function () {
  ...
  const BAR_GRADIENTS = {
    QB: [
      { offset: '0%', color: 'rgba(59, 228, 228, 0.92)' },
      { offset: '54%', color: 'rgba(122, 114, 255, 0.88)' },
      { offset: '100%', color: '#4723FF' }
    ],
    RB: [
      { offset: '0%', color: 'rgba(255, 117, 209, 0.92)' },
      { offset: '58%', color: 'rgba(255, 157, 112, 0.88)' },
      { offset: '100%', color: '#FF3B8F' }
    ],
    WR: [
      { offset: '0%', color: 'rgba(124, 131, 255, 0.92)' },
      { offset: '56%', color: 'rgba(255, 142, 208, 0.9)' },
      { offset: '100%', color: '#7A2DFF' }
    ],
    TE: [
      { offset: '0%', color: 'rgba(70, 231, 255, 0.92)' },
      { offset: '60%', color: 'rgba(134, 255, 205, 0.88)' },
      { offset: '100%', color: '#2BC4A5' }
    ],
    DEFAULT: [
      { offset: '0%', color: 'rgba(124, 131, 255, 0.82)' },
      { offset: '100%', color: '#5C4BFF' }
    ]
  };
