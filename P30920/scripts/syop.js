(function () {
  ...
  function renderDraftPositional() {
    ...
    roundLabelGroups.forEach((entries) => {
      ...
      const topBase = isCompact ? -34 : -38;
      const topSpacing = isCompact ? 6 : 7;
      const bottomBase = isCompact ? 24 : 26;
      const bottomSpacing = isCompact ? 6 : 8;
      const midOffset = isCompact ? 4 : 6;
