...
function showLegend(){ try{ document.getElementById('legend-section')?.classList.remove('hidden'); }catch(e){} }
        ...
        const COMPARE_BUTTON_SHOW_ALL_HTML = '<span class="compare-button-icon-label"><i aria-hidden="true" class="fa-solid fa-arrows-left-right-to-line"></i><span class="label">Show All</span></span>';
