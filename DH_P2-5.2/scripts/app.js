        ...
        function renderPlayerComparison(players) {
            ...
            if (footer && keyContainer) {
                ...
                const statDescriptions = {
                    ...
                    'IMP/G': 'Impact per Game',
                    'paRTG': 'Passer Rating',
                    'pIMP': 'Passing Impact',
                    'pIMP/A': 'Passing Impact per Attempt',
                    'INT': 'Interceptions',
                    'SACK': 'Sacks Taken',
                    'CAR': 'Carries',
                    'ruYDS': 'Rushing Yards',
                    ...
                    '1DRR': 'First Down Reception Rate',
                    'TS%RR': 'Targets per Route Run',
                    'RR': 'Routes Run',
                ...
                for (const key in statDescriptions) {
                    listHtml += `<li><strong>${key}:</strong> ${statDescriptions[key]}</li>`;
                }
                listHtml += '</ul>';
